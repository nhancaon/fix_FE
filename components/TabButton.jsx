...
export default ({item, accessibilityState, onPress}) => {
    ...
    return(
        ...
        >
            ...
            >
                <Animated.View style={[{width: 50, height: 50, borderRadius: 100, position: 'absolute', backgroundColor: '#ffffff'}, scaleStyles]}/>
                <  MaterialCommunityIcons
 name={item.icon} color={accessibilityState.selected ? '#ff9c01' : '#ffffff'} size={22}/>
            </Animated.View>
