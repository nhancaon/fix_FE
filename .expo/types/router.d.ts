...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(accountant)/AccountantHome` | `/AccountantHome` | `/(accountant)/InventoryPage` | `/InventoryPage` | `/(accountant)/OrderPage` | `/OrderPage` | `/(accountant)/ProduceOrderPage` | `/ProduceOrderPage` | `/(accountant)/Profile/EditProfilePage` | `/Profile/EditProfilePage` | `/(accountant)/Profile/ProfilePage` | `/Profile/ProfilePage` | `/(accountant)/Profile/ResetPassword` | `/Profile/ResetPassword` | `/(accountant)/Profile/stylesProfile` | `/Profile/stylesProfile` | `/(accountant)/SaleForecastDetailPage` | `/SaleForecastDetailPage` | `/(accountant)/SaleForecastPage` | `/SaleForecastPage` | `/(accountant)/SaleOrderPage` | `/SaleOrderPage` | `/(accountant)/Stack/ProfileStack` | `/Stack/ProfileStack` | `/(accountant)/WordOrderPage` | `/WordOrderPage` | `/(auth)/recover-password` | `/recover-password` | `/(auth)/sign-in` | `/sign-in` | `/(auth)/sign-up` | `/sign-up` | `/(chairman)/ChairmanHome` | `/ChairmanHome` | `/(productManager)/PMBOM` | `/PMBOM` | `/(productManager)/ProductionSchedule` | `/ProductionSchedule` | `/(productManager)/ProductManagerHome` | `/ProductManagerHome` | `/(productManager)/WorkOrder` | `/WorkOrder`;
  // prettier-ignore
