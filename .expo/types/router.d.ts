...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(accountant)/AccountantHome` | `/AccountantHome` | `/(accountant)/InventoryPage` | `/InventoryPage` | `/(accountant)/WordOrderPage` | `/WordOrderPage` | `/(auth)/sign-in` | `/sign-in` | `/(auth)/sign-up` | `/sign-up` | `/(chairman)/ChairmanHome` | `/ChairmanHome` | `/(productManager)/PMBOM` | `/PMBOM` | `/(productManager)/ProductionSchedule` | `/ProductionSchedule` | `/(productManager)/ProductManagerHome` | `/ProductManagerHome` | `/(productManager)/WorkOrder` | `/WorkOrder`;
  // prettier-ignore
