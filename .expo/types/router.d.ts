...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(accountant)` | `/(auth)` | `/(chairman)` | `/(productManager)` | `/AccountantHome` | `/ChairmanHome` | `/InventoryPage` | `/PMBOM` | `/ProductManagerHome` | `/ProductionSchedule` | `/WordOrderPage` | `/WorkOrder` | `/_sitemap` | `/sign-in` | `/sign-up`;
